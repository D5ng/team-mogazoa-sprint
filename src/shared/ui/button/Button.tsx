...
export default function Button({ disabled, isLoading, ...props }: ButtonProps) {
  const commonStyle =
    'relative font-semibold rounded-lg text-lg h-[65px] w-full disabled:cursor-not-allowed disabled:text-black-30 tablet:h-[55px] tablet:text-base mobile:h-[50px] transition'
