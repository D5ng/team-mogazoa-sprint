...
export default function Ranking() {
  ...
  return (
    <div className="fixed top-[100px] right-[170px] mt-[10px] tablet:static flex flex-col tablet:gap-[20px] gap-[30px] max-h-[calc(100vh-100px)]  tablet:overflow-y-hidden none-scrollbar ">
