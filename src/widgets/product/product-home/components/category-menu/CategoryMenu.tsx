...
const CategoryMenu = ({ menuVisible }: CategoryMenuProps) => {
  ...
  return (
    <article
      className={`fixed top-105 mt-[20px] mobile:mt-[50px] tablet:w-full shrink-0 left-[9.5vw] tablet:left-[4vw] ${menuVisible ? '' : 'mobile:hidden'} mobile:w-2/5 mobile:left-0 mobile:bg-black-50 mobile:z-dropdown`}
    >
      <p className="text-[16px] tablet:text-[14px] mobile:mt-[20px] ml-[20px] text-white mb-[10px]">
        카테고리
      </p>
      <ul className="flex flex-col gap-[8px] mobile:mt-[20px]">
