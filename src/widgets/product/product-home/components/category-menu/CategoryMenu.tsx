...
const CategoryMenu = ({ menuVisible }: CategoryMenuProps) => {
  ...
  return (
    <article
      className={`fixed max-h-[calc(100vh-100px)] overflow-y-auto top-[100px]  mobile:mt-[50px]  left-[9vw]  tablet:left-[20px] ${menuVisible ? '' : 'mobile:hidden'} mobile:w-2/5 mobile:left-0 mobile:bg-black-50 mobile:z-dropdown none-scrollbar`}
    >
