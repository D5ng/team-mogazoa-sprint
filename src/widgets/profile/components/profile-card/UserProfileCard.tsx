...
export default function UserProfileCard({
  ...
  return (
    <section
      className={twMerge(
        'flex flex-col justify-center items-center gap-[30px] w-[340px] h-[485px] px-5 py-[30px] bg-black-60 border border-black-70 rounded-xl tablet:w-full tablet:h-[415px] tablet:px-[30px] mobile:h-[415px] mobile:px-5',
        props.className || '',
      )}
    >
